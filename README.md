...
__5. 결과 및 인사이트__
  ...
  [제품] 
  편의점 3사의 크림빵 관련 댓글을 수집하여 감정 분류 모델을 통해 소비자 반응의 경향성을 분석하였습니다. 
...
<br>
가장 많은 대중의 반응이 집중된 CU 연세우유 크림빵에 대해 심층 분석을 진행했습니다. 데이터 양이 방대한 만큼 시계열에 따른 소비자 여론 변화를 가장 명확히 관찰할 수 있었습니다. 

- 출시 초기인 2022년 압도적이었던 기대 감정 비중은 점차 감소한 반면, 2024년에 이르러 분노 감정이 가장 높에 나타났습니다.
- 초기에는 편의점에서 '가성비'와 '풍부한 크림 양'에 집중되었던 긍정적 인식이 점차 높은 열랴으 성분에 대한 공포, 높아진 기대치에 미치지 못하는 크림의 양으로 전이되며 여론이 변화했습니다. 

  <img width="600" height="300" alt="image" src="https://github.com/user-attachments/assets/ce709c87-7d1c-49af-9e2b-fb0c14d64e25" />
...
- 데이터 수집 및 전처리
  - YouTube Data API를 활용하여 편의점 3사 PB 상품 관련 영상의 비정형 댓글 데이터를 수집 했습니다. 
  - 감정 분석의 정확도를 높이기 위해 특수문자 제거, 광고와 같은 영상과 관련 없는 댓글은 제거했습니다.
